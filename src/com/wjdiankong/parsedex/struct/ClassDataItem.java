...
public class ClassDataItem {
    ...
    /**
     * uleb128 unsigned little-endian base 128 struct class_data_item { uleb128
     * static_fields_size; uleb128 instance_fields_size; uleb128
     * direct_methods_size; uleb128 virtual_methods_size; encoded_field
     * static_fields [ static_fields_size ]; encoded_field instance_fields [
     * instance_fields_size ]; encoded_method direct_methods [
     * direct_method_size ]; encoded_method virtual_methods [
    ...
    public String toString() {
        return "static_fields_size:" + static_fields_size + ",instance_fields_size:" + instance_fields_size
                + ",direct_methods_size:" + direct_methods_size + ",virtual_methods_size:" + virtual_methods_size + "\n"
                + getFieldsAndMethods();
    }
